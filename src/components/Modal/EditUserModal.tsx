...
const MiPerfilModal: React.FC<ModalProps> = ({ mostrar, onClose, usuario, editMode }) => {
              ...
              <div className="modal-content">
                <div className="modal-header">
                  {editMode?  (
                    ...
                    <h5 className="modal-title">Perfil de Usuario detalles:</h5>
                  )}
                ...
                <div className="modal-body">
                  ...
                  <MiPerfil pUsuario={usuario} pEditMode={editMode} />
                </div>
